...
namespace MovieCatalogTests
{
    public class MovieCatalogTests
    {
        ...
        public void OneTimeSetup()
        {
            ...
            driver.FindElement(By.Id("form2Example17")).SendKeys("jen@abv.bg");
        ...
        public void AddMovieWithoutTitleTest()
        {
            ...
            var titleField = driver.FindElement(By.CssSelector("input#form2Example17"));
            titleField.Clear();
            titleField.SendKeys(invalidMovieTitle);

            // Find and click the 'Add' button
            var add = driver.FindElement(By.XPath("//button[@class='btn warning']"));
            actions.MoveToElement(add).Perform();
            add.Click();

            // Verify the error message
            var messageElement = driver.FindElement(By.XPath("//div[contains(@class,'toast-message')]"));
        ...
        public void AddMovieWithoutDescriptionTest()
        {
            ...
            // Find and click the 'Add' button
            var addButton = driver.FindElement(By.CssSelector("button.btn.warning"));
        ...
        public void AddMovieWithRandomTitleTest()
        {
            ...
            // Find and click the 'Add' button
            var add = driver.FindElement(By.CssSelector("button.btn.warning"));
            actions.MoveToElement(add).Perform();
            add.Click();
        ...
        public void EditLastAddedMovieTest()
        {
            ...
            var editButton = lastMovieElement.FindElement(By.CssSelector("a.btn.btn-outline-success"));
            editButton.Click();

            // Change the movie title
            lastMovieTitle = "CHANGED " + lastMovieTitle; // Update the lastMovieTitle
            var inputTitle = driver.FindElement(By.Id("form2Example17"));
            inputTitle.Clear();
            inputTitle.SendKeys(lastMovieTitle);

            // Find and click the 'Save Changes' button
            var saveChangesButton = driver.FindElement(By.CssSelector("button.btn.warning"));
        ...
        {
            // Navigate to the All Movies page
            driver.Navigate().GoToUrl($"{BaseUrl}Catalog/All");
